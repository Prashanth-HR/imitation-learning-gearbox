...
from training.datasets import ImageToPoseDatasetFine
from training.networks import ImageToPoseNetworkFine


class ImageToPoseTrainerFine:

    def __init__(self, task_name, num_trajectories):
        self.task_name = task_name
        self.image_to_pose_dataset = ImageToPoseDatasetFine(task_name, num_trajectories)
        self.image_to_pose_network = ImageToPoseNetworkFine(task_name, num_trajectories)
        self.results_directory = '../Results/' + str(task_name) + '/Image_To_Pose_Training_Fine'
        utils.create_directory_if_none(self.results_directory)
        utils.create_directory_if_none(self.results_directory + '/Graphs')
